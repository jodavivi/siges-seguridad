...
const mantUsuarioRolRxBusiness  = require('../business/MantUsuarioRolRxBusiness');  
...
module.exports = function(){
    ...
    router.put('/usuario/asignarempresa', mantUsuarioTxBusiness.asignarEmpresaUsuario); 
    router.delete('/usuario', mantUsuarioTxBusiness.eliminarUsuario);  
    router.get('/usuario', mantUsuarioRxBusiness.consultarUsuario); 
    router.get('/usuario/all', mantUsuarioRxBusiness.consultarUsuarioEmpresaAll);
    router.get('/usuario/rol/noasigando', mantUsuarioRolRxBusiness.consultarRolUsuarioNoAsignado);
    router.get('/usuario/rol', mantUsuarioRolRxBusiness.consultarRolUsuario);
