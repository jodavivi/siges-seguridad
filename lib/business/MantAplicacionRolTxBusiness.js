...
exports.registrarAplicacionRol = async (req, res) => { 
     ...
     try {
		 ...
		 oRequest.oData.forEach(async function(e){
			...
			oAplicacionRol.oData = {};
			oAplicacionRol.oData.sCodRol = req.query.sCodRol;
			oAplicacionRol.oData.iAplicacionId = parseInt(e,10);
			oAplicacionRol.oData.sCodEmpresa	= oEmpresa.CodEmpresa;
			oAplicacionRol.oData.sEmpresa		= oEmpresa.RazonSocial;
