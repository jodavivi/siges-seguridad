...
/**
 * @description Función que permite eliminar aplicaciones por grupo
 * @creation David Villanueva 21/03/2021
 * @update
 */
 exports.eliminarGrupoAplicacionxGrupo = async function (oParam) { 
    const oResponse = {};
    try {
        var oRegistro = {}; 
        oRegistro.UsuarioModificador   = oParam.oAuditRequest.sUsuario;
        ...
        var oFiltro      = {};
        oFiltro.where    = {};
        oFiltro.where.GrupoId = oParam.oData.iGrupoId;
        const eliminarAplicacionGrupoPromise = await grupoAplicacion.update(oRegistro, oFiltro);
        oResponse.iCode     = 1;
        oResponse.sMessage  = 'OK';
        oResponse.oData     = oRegistro;
    } catch (e) { 
