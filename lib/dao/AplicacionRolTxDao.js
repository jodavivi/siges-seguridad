...
exports.crearAplicacionRol = async function (oParam) { 
    ...
    try {
        ...
        console.log(e);
        oResponse.iCode     = -1;
        oResponse.sMessage  = 'Ocurrio un error en la tabla: aplicacion_rol, error: '+ e.message;
 ...
 * @creation David Villanueva 30/03/2021
 * @update
 */
 exports.eliminarAplicacionxCodRol = async function (oParam) { 
    const oResponse = {};
    try {
        var oRegistro = {}; 
        oRegistro.UsuarioModificador   = oParam.oAuditRequest.sUsuario;
        ...
        var oFiltro      = {};
        oFiltro.where    = {};
        oFiltro.where.CodRol = oParam.oData.sCodRol;
        oFiltro.where.EstadoId = 1;
        const eliminarAplicacionGrupoPromise = await aplicacionRol.update(oRegistro, oFiltro);
        oResponse.iCode     = 1;
        oResponse.sMessage  = 'OK';
        oResponse.oData     = oRegistro;
    } catch (e) { 
